...
public class ShootMachineGun extends Entities {
	
	private double dx;
	private double dy;
	private double speed = 4;
	private int Life = 70, curLife = 0;
	public static int DanoShoot = 6;

	public ShootMachineGun(int x, int y, int width, int height, BufferedImage sprite, double dx, double dy) {
		...
		public void update() {
			...
			curLife++;
			if(curLife == Life) {
				Game.shootMachineGun.remove(this);
				return;
			}
		}else {Game.shootMachineGun.remove(this);
